...
color_ranges = {
    ...
    'orange': [([6, 100, 100], [21, 255, 255])],
    'yellow': [([22, 100, 100], [33, 255, 255])],
    # 'lime': [((34, 255, 175), (74, 255, 255))],
    'green': [((34, 255, 40), (74, 255, 174))],
    'cyan': [([75, 100, 100], [101, 255, 255])],   # STRONGGG
    'blue': [([102, 100, 100], [120, 255, 255])],
    'violet': [([150, 100, 100], [169, 255, 255])], # more like light magenta
    'magenta': [([170, 100, 100], [178, 255, 255])], # florescent magenta
    'red_wrap': [((171, 255, 255), (179, 255, 255))],
}
...
while True:
    ...
    for contour in contours:
        if cv2.contourArea(contour) > 100:  # Filter out small areas
            ...
            cv2.rectangle(frame, (x, y), (x + w, y + h), (0, 255, 255), 2)  # Draw rectangle in yellow
